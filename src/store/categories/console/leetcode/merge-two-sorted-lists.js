  ...
  solution: [
    {
      ...
      code: "function mergeTwoLists(l1, l2) {\n  const dummy = new ListNode(0);\n  let currentMerge = dummy;\n  \n  while (l1 && l2) {\n    if (l1.val <= l2.val) {\n      currentMerge.next = l1;\n      l1 = l1.next;\n    } else {\n      currentMerge.next = l2;\n      l2 = l2.next;\n    }\n    currentMerge = currentMerge.next;\n  }\n  \n  currentMerge.next = l1 || l2;\n  return dummy.next;\n}",
    },
  ],
  files: [
    {
  ...
  tests: [
    {
      ...
      code: "const l1 = new ListNode(1, new ListNode(2, new ListNode(4)));\nconst l2 = new ListNode(1, new ListNode(3, new ListNode(4)));\nconst mergeResult = mergeTwoLists(l1, l2);\nconsole.log('Merged list:', mergeResult);"
    }
  ],
};
